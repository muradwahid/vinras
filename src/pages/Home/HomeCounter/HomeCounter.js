  ...
  return (
    <div className='bg-color'>
      <div className='w-[74%] mx-auto'>
        <div className='grid xl:grid-cols-5 lg:grid-cols-5 md:grid-cols-3 grid-cols-1 pb-16 pt-20 gap-4'>
          <div className='grid gap-3 poppins text-center bg-white py-6 px-3 rounded-md'>
