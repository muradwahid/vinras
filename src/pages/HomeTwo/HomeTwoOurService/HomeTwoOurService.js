...
const serviceBg = 'https://i.ibb.co/pnjr8Tp/Home2-bg.png';
...
const HomeTwoOurService = () => {
  return (
    <div className='pt-48 pb-20' style={{backgroundImage:`url(${serviceBg})`,backgroundSize:'cover',backgroundPosition:'center',backgroundRepeat:'no-repeat'}}>
...
export default HomeTwoOurService;